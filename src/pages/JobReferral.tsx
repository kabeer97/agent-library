    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="px-[150px] py-12 max-md:px-5">
        <nav className="flex items-center gap-2 text-sm text-gray-600 mb-8">
          ...
          <span>›</span>
          <span className="text-gray-900">Job Referral</span>
        </nav>
          ...
          <div className="bg-gradient-to-r from-teal-100 to-teal-200 rounded-3xl p-12 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-700 max-w-2xl">
                Agentic AI enables employees to seamlessly refer candidates for open roles by guiding them through the submission process, validating eligibility, and tracking referral status.
              </p>
            </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Easy Referral Submission</h4>
                  <p className="text-sm text-gray-600">Simplifies sharing candidate info.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Highlights Open Roles</h4>
                  <p className="text-sm text-gray-600">Matches referrals to current openings.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Improves Candidate Tracking</h4>
                  <p className="text-sm text-gray-600">Keeps referrals visible to recruiters.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Boosts Talent Pipeline</h4>
                  <p className="text-sm text-gray-600">Encourages employee-driven hiring.</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Browse agents related to Job Referral, or{' '}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2">HR</p>
                  <p className="text-sm text-gray-700">
                    Helps monitor, notify, and guide employees on overdue training.
                  </p>
                </div>
              </div>
            </div>
