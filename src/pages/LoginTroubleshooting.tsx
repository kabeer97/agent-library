...
const LoginTroubleshooting: React.FC = () => {
  const useCase = useCases.find(uc => uc.title === "Login Troubleshooting");
          ...
          <div className="w-80 max-lg:w-full space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Instant Issue Detection</h4>
                  <p className="text-gray-600">AI quickly identifies root causes of login failures.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Cross-System Compatibility</h4>
                  <p className="text-gray-600">Handles login problems across multiple platforms.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Proactive User Prompts</h4>
                  <p className="text-gray-600">Guides users step-by-step to resolution.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Reduced Helpdesk Load</h4>
                  <p className="text-gray-600">Deflects repetitive login issues from IT teams.</p>
                </div>
              </div>
            </div>
