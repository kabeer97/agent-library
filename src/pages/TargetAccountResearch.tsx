    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="px-[150px] py-12 max-md:px-5">
        <nav className="flex items-center gap-2 text-sm text-gray-600 mb-8">
          ...
          <span>›</span>
          <span className="text-gray-900">Target Account Research</span>
        </nav>
          ...
          <div className="bg-gradient-to-r from-purple-200 to-purple-300 rounded-3xl p-12 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-700 max-w-2xl">
                Automates account research by gathering and synthesizing company news, executive changes, financials, hiring trends, and social sentiment. It delivers sales-ready briefs that help reps quickly understand an account's current landscape, pain points, and buying signals—saving hours of manual research.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex gap-1">
                    <img 
                      src="/lovable-uploads/420f4eb2-22bd-4036-973b-69427cd80338.png" 
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Deep Account Context</h4>
                  <p className="text-sm text-gray-600">Informed conversations.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Automated Research</h4>
                  <p className="text-sm text-gray-600">Saves rep time.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Real-Time Updates</h4>
                  <p className="text-sm text-gray-600">Fresh insights always.</p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Sales Strategy Alignment</h4>
                  <p className="text-sm text-gray-600">Improves targeting precision.</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-purple-100 via-indigo-50 to-blue-100 rounded-lg p-12 text-center">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Browse plugins related to Target Account Research, or{' '}
...
export default TargetAccountResearch;
