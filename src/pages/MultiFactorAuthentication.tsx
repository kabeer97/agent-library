...
const MultiFactorAuthentication: React.FC = () => {
  const useCase = useCases.find(uc => uc.title === "Multi-Factor Authentication");
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="px-[150px] py-8 max-md:px-5">
        ...
        <div className="relative mb-8">
          <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="w-80 max-lg:w-full space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Smooth MFA Onboarding</h4>
                  <p className="text-gray-600">Guides users through setup with no confusion.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Real-Time Troubleshooting</h4>
                  <p className="text-gray-600">Fixes enrollment or token issues instantly.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Secure Bypass Support</h4>
                  <p className="text-gray-600">Handles temporary access needs safely.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Reduced MFA-Related Tickets</h4>
                  <p className="text-gray-600">Frees IT from common MFA issues.</p>
                </div>
              </div>
            </div>
