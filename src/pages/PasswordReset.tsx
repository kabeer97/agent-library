...
const PasswordReset: React.FC = () => {
  const useCase = useCases.find(uc => uc.title === "Password Reset");
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="px-[150px] py-8 max-md:px-5">
        ...
        <div className="relative mb-8">
          <div className="bg-gradient-to-r from-red-100 to-red-200 rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="w-80 max-lg:w-full space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">24/7 Password Reset Support</h4>
                  <p className="text-gray-600">AI enables self-service recovery anytime.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Unified Credential Handling</h4>
                  <p className="text-gray-600">Manages passwords across multiple systems.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Secure Identity Verification</h4>
                  <p className="text-gray-600">Built-in checks protect against misuse.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Reduced Wait Times</h4>
                  <p className="text-gray-600">Faster resolutions than traditional support.</p>
                </div>
              </div>
            </div>
