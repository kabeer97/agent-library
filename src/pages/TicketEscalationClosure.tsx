...
const TicketEscalationClosure: React.FC = () => {
  const useCase = useCases.find(uc => uc.title === "Ticket Escalation & Closure");
          ...
          <div className="w-80 max-lg:w-full space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">AI-Driven Escalation Rules</h4>
                  <p className="text-gray-600">Agentic AI escalates based on urgency, SLA, or user signals.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">User-Led Closure</h4>
                  <p className="text-gray-600">Users can close resolved tickets directly through the bot.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Feedback Collection Built-In</h4>
                  <p className="text-gray-600">AI prompts for feedback or survey at ticket close.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Prevents SLA Violations</h4>
                  <p className="text-gray-600">Timely escalation reduces resolution delays.</p>
                </div>
              </div>
            </div>
