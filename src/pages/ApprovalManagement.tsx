...
const ApprovalManagement: React.FC = () => {
  const useCase = useCases.find(uc => uc.title === "Approval Management");
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="px-[150px] py-8 max-md:px-5">
        ...
        <div className="relative mb-8">
          <div className="bg-gradient-to-r from-blue-100 to-blue-200 rounded-3xl p-8 relative overflow-hidden">
          ...
          <div className="w-80 max-lg:w-full space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Automated Approval Routing</h4>
                  <p className="text-gray-600">Requests are sent to the right approvers with no delays.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Multi-Level Approval Support</h4>
                  <p className="text-gray-600">Handles complex, sequential approval workflows efficiently.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Real-Time Status Updates</h4>
                  <p className="text-gray-600">Users and approvers receive live alerts and reminders.</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Reduced Processing Delays</h4>
                  <p className="text-gray-600">AI ensures faster turnaround on requests.</p>
                </div>
              </div>
            </div>
